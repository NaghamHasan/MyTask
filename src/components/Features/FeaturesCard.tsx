...
const FeaturesCard = ({ svg, title, desc }: FeaturesCardParam) => {
  return (
    <div className="relative p-8 text-center sm:text-start bg-[#E7F2EF] rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 group">
